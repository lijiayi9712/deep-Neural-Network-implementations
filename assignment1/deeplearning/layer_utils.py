...
def conv_relu_conv_relu_pool_backward(dout, cache):
  ...
  ds = max_pool_backward_fast(dout, pool_cache)
  da2 = relu_backward(ds, relu_cache2)
  dx2, dw2, db2 = conv_backward_fast(da2, conv_cache2)
  da1 = relu_backward(ds, relu_cache1)
  dx, dw, db = conv_backward_fast(da1, conv_cache1)
  return dx, dw, db

def affine_bn_relu_forward(x , w , b, gamma, beta, bn_param):
    out, af_cache = affine_forward(x, w, b)
    bn, bn_cache = batchnorm_forward(out, gamma, beta, bn_param)
